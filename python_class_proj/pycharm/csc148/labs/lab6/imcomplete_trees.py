...
class Tree:
    ...
    def __contains__(self, item):
        ...
        if self.is_empty():
            ...
            for trees in self._subtrees:
                if trees.__contains__(item) is True:
                    return True
            return None
    ...
    def branching_factor(self):
        ...
        if self.is_empty():
            ...
            branches = branches + len(self._subtrees)
            for trees in self._subtrees:
                branches = branches + trees.branching_factor()
            return float(branches/(nodes - num_leaves))
    ...
    def insert(self, item):
        ...
        if self.is_empty():
            ...
            if random_num == 3:
                new_tree = Tree(item)
                self.add_subtrees([new_tree])
            elif random_num == 1 or random_num == 2:
                self._subtrees[randint(0, len(self._subtrees)-1)].insert(item)
    ...
    def insert_child(self, item, parent):
        ...
        if self.is_empty():
            ...
            for trees in self._subtrees:
                bool = trees.insert_child(item, parent)
                if bool is True:
                    return True
            return False
        pass
