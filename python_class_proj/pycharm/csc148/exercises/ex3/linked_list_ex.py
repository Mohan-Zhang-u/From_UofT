...
class LinkedList:
    ...
    def __eq__(self, other):
        ...
        if curr is None and curr_other is None:
            return True
        else:
            return False
    ...
    def delete_all(self, item):
        ...
        >>> linky11 = LinkedList([2, 1, 1])
        >>> linky11.delete_all(1)
        >>> str(linky11)
        '[2]'
        >>> linky = LinkedList([1, 1, 2, 1, 3, 1, 1, 1])
        >>> linky.delete_all(1)
        >>> str(linky)
        '[2 -> 3]'
        >>> linky.delete_all(5)
        >>> str(linky)
        '[2 -> 3]'
        >>> linky2 = LinkedList([1, 1, 1, 1, 1])
        >>> linky2.delete_all(1)
        >>> str(linky2)
        '[]'
        >>> linky2 = LinkedList([1, 1, 1, 1, 1, 2])
        >>> linky2.delete_all(1)
        >>> str(linky2)
        '[2]'
        """
        ...
        while curr is not None:
            if curr.item == item:
                ...
                curr_one = curr
                # curr one is always the node before curr
                curr = curr.next
