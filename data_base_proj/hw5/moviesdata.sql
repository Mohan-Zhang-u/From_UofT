...
INSERT INTO Movie(title, year, length, inColor, studioName, producerC)
VALUES('Titanic', 1998, 340, 1 , 'Paramount', 101);
...
INSERT INTO Movie(title, year, length, inColor, studioName, producerC)
VALUES('Who Framed Roger Rabbit', 1988, 134, 1, 'Disney', 222);
...
INSERT INTO "MovieExec"(name, address, certN, netWorth)
...
INSERT INTO "MovieExec"(name, address, certN, netWorth)
VALUES ('James Cameron', 'Slow Lane', 101, 20000000);

--insert into studio
INSERT INTO Studio (name, address, presCertN)
